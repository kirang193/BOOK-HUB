...
class DescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(intent!=null){
            ...
            finish()
            Toast.makeText(this@DescriptionActivity,"Intent not received!!",Toast.LENGTH_SHORT).show()
        }

        if(bookId=="100"){
            finish()
            Toast.makeText(this@DescriptionActivity,"Intent received but book not found!!",Toast.LENGTH_SHORT).show()
        }
            ...
            val jsonRequest=object: JsonObjectRequest(Request.Method.POST,url,jsonParams, Response.Listener {
                ...
                try {
                    ...
                    if (success){
                        ...
                        if(isFav){
                            btnAddToFav.text="Removed from Favourites"
